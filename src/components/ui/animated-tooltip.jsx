...
// import img from "../../assets/logo-images/credenz23.avif"
			...
			{items.map((item, idx) => (
				<div
					...
					<LazyLoadImage
						...
						src={item.image}
						alt={item.name}
						className="object-cover !m-0 !p-0 object-top rounded-full md:h-30 md:w-30 lg:h-36 lg:w-36 border-2  group-hover:scale-105 group-hover:z-30 border-blue-950  relative transition duration-500"
					/>
				</div>
			))}
		</>
